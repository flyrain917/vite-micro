import { e as effectScope, r as ref$1, m as markRaw } from "./reactivity.esm-bundler-0e10a3a0.js";
(function polyfill() {
...
const moduleMap = { "vue": { get: () => () => __federation_import$1("./__federation_shared_vue.js"), import: true } };
...
/*!
  ...
  * @license MIT
  */
const { getCurrentInstance, inject, onUnmounted, onDeactivated, onActivated, computed, unref, watchEffect, defineComponent: defineComponent$1, reactive, h, provide, ref, watch, shallowRef, shallowReactive, nextTick } = await importShared("vue");
...
const remotesMap = {
  "loginRemote": { url: "/assets/login/remoteEntrys.js?version=v1690795157706", format: "esm", from: "vite" },
  "userRemote": { url: "/assets/user/remoteEntrys.js?version=v1690795157706", format: "esm", from: "vite" }
};
...
const wrapShareModule = (remoteFrom) => {
  return {
    "vue": { "3.3.0": { get: () => get("./__federation_shared_vue.js", remoteFrom), loaded: 1 } }
  };
};
...
function getComp(name, base, mountFunc, unMountFunc) {
  return defineComponent({
    ...
    render(h2) {
      return this.$createElement("div", { style: "height: 100%" }, [h2("div", { id: name })]);
    }
  });
}
...
const mainRoute = [
  ...
  {
    path: "/home",
    component: () => __vitePreload(() => import("./Home-531e28d7.js"), true ? [] : void 0)
  },
  {
    path: "/login",
...
const createRouter = (base) => createRouter$1({
  mode: "history",
  history: createWebHistory(),
  base: "/",
  routes: mainRoute
});
async function setupRouter(app2, base) {
...
const _hoisted_1 = /* @__PURE__ */ _createElementVNode("h2", null, "this is Main module", -1);
...
let app = null;
async function mount(name, base) {
  app = createApp(App);
  setupStore(app);
  setupRouter(app);
  app.mount(name);
