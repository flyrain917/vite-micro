...
/*!
  ...
  * @license MIT
  */
const { getCurrentInstance, inject, onUnmounted, onDeactivated, onActivated, computed, unref, watchEffect, defineComponent: defineComponent$1, reactive, h: h$1, provide, ref, watch, shallowRef, shallowReactive, nextTick } = await importShared("vue");
...
const remotesMap = {
  "loginRemote": { url: "/assets/login/remoteEntrys.js?version=v1690795312100", format: "esm", from: "vite" },
  "userRemote": { url: "/assets/user/remoteEntrys.js?version=v1690795312100", format: "esm", from: "vite" }
};
...
const mainRoute = [
  ...
  {
    path: "/home",
    component: () => __vitePreload(() => import("./Home-054b538c.js"), true ? [] : void 0)
  },
  {
    path: "/login",
