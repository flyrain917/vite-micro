...
const remotesMap = {
  "loginRemote": { url: "/assets/login/remoteEntrys.js?version=v1690795087047", format: "esm", from: "vite" },
  "userRemote": { url: "/assets/user/remoteEntrys.js?version=v1690795087047", format: "esm", from: "vite" }
};
...
const mainRoute = [
  ...
  {
    path: "/home",
    component: () => __vitePreload(() => import("./Home-9b9a126c.js"), true ? [] : void 0)
  },
  {
    path: "/login",
