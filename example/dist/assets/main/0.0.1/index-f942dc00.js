...
const remotesMap = {
  "loginRemote": { url: "/assets/login/remoteEntrys.js?version=v1690795200501", format: "esm", from: "vite" },
  "userRemote": { url: "/assets/user/remoteEntrys.js?version=v1690795200501", format: "esm", from: "vite" }
};
...
function getComp(name, base, mountFunc, unMountFunc) {
  return defineComponent({
    ...
    render(h1) {
      ...
      return h2("div", { style: "height: 100%" }, [h2("div", { id: name })]);
    }
  });
}
...
const mainRoute = [
  ...
  {
    path: "/home",
    component: () => __vitePreload(() => import("./Home-19b99379.js"), true ? [] : void 0)
  },
  {
    path: "/login",
