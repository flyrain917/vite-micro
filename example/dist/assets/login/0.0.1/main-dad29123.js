...
import { effectScope, ref as ref$1, markRaw } from "./reactivity.esm-bundler-d96ea1ab.js";
...
const loginRoute = [
  ...
  {
    path: "/pwd",
    component: () => __vitePreload(() => import("./Login-d7f72046.js"), true ? ["./Login-d7f72046.js","./__federation_fn_import.js","./preload-helper-0ba3de33.js"] : void 0, import.meta.url)
  }
];
...
const _hoisted_1 = /* @__PURE__ */ _createElementVNode("h2", null, "this is login module", -1);
...
const { createApp, defineExpose } = await importShared("vue");
console.log("===defineExpose==", defineExpose);
let app = null;
